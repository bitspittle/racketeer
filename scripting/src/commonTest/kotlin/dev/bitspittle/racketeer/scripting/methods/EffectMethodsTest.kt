...
class EffectMethodsTest {
    ...
    fun testFxAddMethod() = runTest {
        ...
        env.addMethod(FxAddMethod(service::gameState, service::addGameChange))
        ...
        gameState.addChange(GameStateChange.Draw(gameState.handSize))
        ...
        gameState.addChange(GameStateChange.Play(gameState.hand.cards.first())); --expectedHandSize
