...
class ExpandShopCommand(ctx: GameContext, padding: Int) : Command(ctx) {
    init {
    ...
    override val title = "${"Expand shop".padEnd(padding)} ${ctx.describer.describeInfluence(influenceCost)}"
