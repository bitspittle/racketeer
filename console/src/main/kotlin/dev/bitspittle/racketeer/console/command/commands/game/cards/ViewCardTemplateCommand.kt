...
class ViewCardTemplateCommand(
    ...
    override val description = if (shouldMaskCard) "You must own this card at least once to see its details." else ctx.describer.describeCardBody(card, includeFlavor = includeFlavor)
}
