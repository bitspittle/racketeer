...
object GameMenus {
    object Main : GameMenuEntry {
        ...
        override fun renderContent(params: GameMenuEntry.Params) {
            ...
            MenuButton(
                ...
                BrowseAllCards(
                    params.ctx.data,
                    initialSortingOrder = if (params.ctx.state.isGameInProgress) BrowseAllCards.SortingOrder.PILE else BrowseAllCards.SortingOrder.VICTORY_POINTS
                )
            )
    ...
    object Admin : GameMenuEntry {
        ...
        object MoveCards {
            ...
            class ChooseCards(state: GameState, describer: Describer, val pile: Pile) : GameMenuEntry {
                ...
                @Composable
                override fun renderExtraBottomButtons(params: GameMenuEntry.Params) {
                    Button(
                        onClick = {
    ...
    class BrowseAllCards(
        data: GameData,
        initialSortingOrder: SortingOrder = SortingOrder.PILE,
...
fun GameMenu(
    ...
    val menuStack = remember { mutableStateListOf(initialMenu ?: GameMenus.Main) }
